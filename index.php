...
<html>
	<head>
	<title>CATALOGUE DE BIBLIOTHEQUE</title>
	<link href="style.css" type="text/css" rel="stylesheet" />
	</head>
	<body>
		<h2 style="text-align:center">CATALOGUE DE BIBLIOTHEQUE</h2>
    ...
    <div id="toys-grid">      
			...
			<p><input type="text" placeholder="عنوان الكتاب" name="search[name]" class="demoInputBox" value="<?php echo $name; ?>"	/><input type="text" placeholder="اسم المؤلف" name="search[code]" class="demoInputBox" value="<?php echo $code; ?>"	/><input type="submit" name="go" class="btnSearch" value="Search"><input type="reset" class="btnSearch" value="Reset" onclick="window.location='index.php'"></p>
			</div>
